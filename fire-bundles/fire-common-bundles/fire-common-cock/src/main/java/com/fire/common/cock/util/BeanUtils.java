...
import com.fire.common.cock.exception.BeansException;
import com.fire.common.cock.exception.BeanInstantiationException;
import com.fire.common.cock.exception.FatalBeanException;
...
public abstract class BeanUtils {
	 ...
	 * {@code findDeclaredMethod}. This allows to find public methods without
	 * issues even in environments with restricted Java security settings.
	 * 
	 * @param clazz
	 *            the class to check
	 * @param methodName
	...
	public static Method findMethodWithMinimalParameters(Class<?> clazz,
		...
		Method targetMethod = findMethodWithMinimalParameters(
				clazz.getMethods(), methodName);
	...
	public static Method findDeclaredMethodWithMinimalParameters(
		...
		if (targetMethod == null && clazz.getSuperclass() != null) {
			targetMethod = findDeclaredMethodWithMinimalParameters(
	 ...
	 * where {@code arg_list} is an optional, comma-separated list of
	 * fully-qualified type names, and attempts to resolve that signature
	 * against the supplied {@code Class}.
	 * <p>
	 * When not supplying an argument list ({@code methodName}) the method whose
	 * name matches and has the least number of parameters will be returned.
	 * When supplying an argument type list, only the method whose name and
	 * argument types match will be returned.
	 * <p>
	 * Note then that {@code methodName} and {@code methodName()} are
	 * <strong>not</strong> resolved in the same way. The signature
	 * {@code methodName} means the method called {@code methodName} with the
	 * least number of arguments, whereas {@code methodName()} means the method
	...
	/**
	 * Find a JavaBeans {@code PropertyDescriptor} for the given method, with
	 * the method either being the read method or the write method for that bean
	 * property.
	 * 
	 * @param method
	...
	/**
	 * Instantiate a class using its no-arg constructor. As this method doesn't
	...
	public static void copyProperties(Object source, Object target,
			boolean isSetNullValue) throws BeansException {
		copyProperties(source, target, null, isSetNullValue, (String[]) null);
	}
	 ...
	 */
	public static void copyProperties(Object source, Object target,
			Class<?> editable, boolean isSetNullValue) throws BeansException {
		copyProperties(source, target, editable, isSetNullValue,
				(String[]) null);
	}
	 ...
	 */
	public static void copyProperties(Object source, Object target,
			boolean isSetNullValue, String... ignoreProperties)
			throws BeansException {
		copyProperties(source, target, null, isSetNullValue, ignoreProperties);
	}
	...
	private static void copyProperties(Object source, Object target,
			Class<?> editable, boolean isSetNullValue,
