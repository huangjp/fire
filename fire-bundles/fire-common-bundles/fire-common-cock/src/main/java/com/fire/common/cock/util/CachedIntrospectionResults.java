...
import com.fire.common.cock.CommonUtilCockActivator;
...
public class CachedIntrospectionResults {
	...
	public <T> List<T> loadFactories(Class<T> factoryClass, ClassLoader classLoader) {
		...
		if (classLoader == null) {
			classLoader = CommonUtilCockActivator.class.getClassLoader();
		}
	...
	private <T> T instantiateFactory(String instanceClassName, Class<T> factoryClass, ClassLoader classLoader) {
		try {
	...
	public List<String> loadFactoryNames(Class<?> factoryClass, ClassLoader classLoader) {
		...
		try {
			...
			while (urls.hasMoreElements()) {
				...
				Properties properties = loadProperties(new UrlResource(url));
	...
	public void fillProperties(Properties props, Resource resource) throws IOException {
...
//	private final Map<PropertyDescriptor, TypeDescriptor> typeDescriptorCache;
	...
	private CachedIntrospectionResults(Class<?> beanClass) throws BeansException {
		try {
			...
			List<BeanInfoFactory> beanInfoFactories = loadFactories(
