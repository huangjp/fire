...
import static com.fire.core.transaction.WolfSqlSessionUtils.*;
 ...
 * @version $Id$
 */
public class WolfSqlSessionTemplate implements SqlSession {
	...
	private final MyBatisExceptionTranslator exceptionTranslator;
	 ...
	 */
	public WolfSqlSessionTemplate(SqlSessionFactory sqlSessionFactory) {
	...
	public WolfSqlSessionTemplate(SqlSessionFactory sqlSessionFactory,
			ExecutorType executorType,
			MyBatisExceptionTranslator exceptionTranslator) {
	 ...
	 */
	private class WolfSqlSessionInterceptor implements InvocationHandler {

		@Override
		public Object invoke(Object proxy, Method method, Object[] args)
				throws Throwable {
			SqlSession sqlSession = getSqlSession(
					WolfSqlSessionTemplate.this.sqlSessionFactory,
					WolfSqlSessionTemplate.this.executorType,
					WolfSqlSessionTemplate.this.exceptionTranslator);
			try {
