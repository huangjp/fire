...
public class StringUtils {
	...
	// StrBuilder buf = new StrBuilder(256); // Java default is 16, probably too
	// small
	// if (first != null) {
	// buf.append(first);
	// }
	...
	public static String overlayString(String text, String overlay, int start,
			int end) {
		return new StrBuilder(start + overlay.length() + text.length() - end
	 ...
	 * @return
	 */
	public static String[] split2(String str, String sign){
